$(function () {
    ...
    function getSongList() {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                songs = songs.concat(JSON.parse(xmlhttp.responseText));
                if (currIndex == -1) {
                    initPlayer();
                }
            } else {
    ...
    function selectTrack(flag) {
        ...
        if ((currIndex > -1) && (currIndex < songs.length)) {
            ...
            currAlbum = songs[currIndex]['album'];
            currTrackName = songs[currIndex]['trackName'];
            currArtwork = songs[currIndex]['albumArtwork'];

            audio.src = songs[currIndex]['trackUrl'];
            ...
            albumImg.src = songs[currIndex]['albumArtwork'];
            bgArtworkUrl = songs[currIndex]['albumArtwork'];
    ...
    getSongList();
    // setTimeout(function(){playPauseButton.click()},2000);
    // selectTrack(playFlag);
    // playPause();
});